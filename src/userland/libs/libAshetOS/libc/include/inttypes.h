...
// TODO: mquickjs includes inttypes.h, but not stdint.h
#include <stdint.h>

typedef struct _ashet_imaxdiv {
    intmax_t rem;
    intmax_t quot;
} imaxdiv_t;
...
intmax_t  strtoimax(char const * __restrict, char ** __restrict, int);
uintmax_t strtoumax(char const * __restrict, char ** __restrict, int);

intmax_t  wcstoimax(wchar_t const * __restrict, wchar_t ** __restrict, int);
uintmax_t wcstoumax(wchar_t const * __restrict, wchar_t ** __restrict, int);
