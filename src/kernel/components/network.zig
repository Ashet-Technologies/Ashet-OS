...
pub const NetworkInterface = struct {
    pub const VTable = struct {
        ...
        linkIsUpFn: std.meta.FnPtr(fn (*ashet.drivers.Driver) bool),
        ...
        /// to `send`.
        allocOutgoingPacketFn: std.meta.FnPtr(fn (*ashet.drivers.Driver, size: usize) ?[]u8),
        ...
        sendFn: std.meta.FnPtr(fn (*ashet.drivers.Driver, buffer: []u8) bool),

        /// Polls the NetworkInterface for new incoming packages.
        /// Is called periodically to ensure network liveness.
        pollFn: std.meta.FnPtr(fn (*ashet.drivers.Driver) void),
    };
